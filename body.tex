...
Eventhough this is just a sub-optimal learning-based approach to this problem, it still has the advantage of \emph{interpretability}; although the generated output might be too contamined with false alarms and (at the same time) missed true transients, the process is fully transparent to the downstream users of the alerts and they may come up with their own post-processing blocks per need.
